...
@synthesize url, podcastTitle, myTitle;
...
- (void)createStreamer
{
	...
	NSURL *nurl = [NSURL URLWithString:escapedValue];
	streamer = [[AudioStreamer alloc] initWithURL:nurl];
...
- (void)viewDidLoad
{
    ...
    self.podcastTitle.text = self.myTitle;
...
//    finished - is the andimation finised?
//
